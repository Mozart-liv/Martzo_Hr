<template>
    <div>
        <Header title="Attendance update"></Header>
        <div class="container">
            <div class="card my-15 ">
                <div class="card-body p-5">
                    <h1 class="mb-5 text-primary">Update Attendance</h1>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getOldData(id){
                axios.get("http://localhost:8000/api/attendance/update/" + id).then((response)=>{
            ...
            updateAttendance(){
                axios.post("http://localhost:8000/api/attendance/update", this.data).then((response)=>{
