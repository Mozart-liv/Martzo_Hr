<template>
    <div>
        <Header title="Profile update"></Header>
        <div class="container">
                    ...
                    <form class="text-start row">
                        ...
                        <div class="col-md-6 px-3">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select disabled class="select form-control form-control-lg" v-model="data.department_id" :class="errors.department_id ? 'is-invalid' : ''" > 
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select disabled class="select form-control form-control-lg" v-model="data.role_id" :class="errors.role_id ? 'is-invalid' : ''" >
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select disabled class="select form-control form-control-lg" v-model="data.is_present" :class="errors.is_present ? 'is-invalid' : ''" >
