        ...
        <div class="container">
            <div class="card my-15 col-md-6 mx-auto">
                <div class="card-body p-5">
                    <h1 class="mb-5 text-primary">Add Role</h1>
                    <form class="text-start row">
                        ...
                        <div class="d-flex justify-content-center my-3">
                            <button type="button"
                            class="btn btn-primary text-white btn-block btn-lg " @click="createRole()" >ADD</button>
                        </div>
...
<script>
    ...
    export default {
       ...
       methods: {
        ...
        createRole(){
            axios.post('http://localhost:8000/api/role/create', this.data).then((response)=>{
